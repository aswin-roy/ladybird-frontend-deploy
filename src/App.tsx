...
// Lazy load pages for performance <!-- id: 36 -->
...
const WorkSchedule = React.lazy(() => import('./pages/WorkSchedule').then(module => ({ default: module.WorkSchedule })));
const Measurements = React.lazy(() => import('./pages/Measurements').then(module => ({ default: module.Measurements })));
...
const SalesReport = React.lazy(() => import('./pages/SalesReport').then(module => ({ default: module.SalesReport })));
const WorkerReport = React.lazy(() => import('./pages/WorkerReport').then(module => ({ default: module.WorkerReport })));
